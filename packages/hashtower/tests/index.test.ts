...
describe("HashTowerHashChainProofBuilder", () => {
    it("Should build a proof", () => {
        const pb = new HashTowerHashChainProofBuilder(10, 4, poseidon)
    ...
    it("Should not initialize with wrong parameters", () => {
        const fun1 = () => new HashTowerHashChainProofBuilder(10, 4, undefined as any)
        const fun2 = () => new HashTowerHashChainProofBuilder(10, 4, 1 as any)
    ...
    it("Should not add a item in a full tower", () => {
        const pb = new HashTowerHashChainProofBuilder(2, 3, poseidon)
