...
/**
 * Calculate the poseidon hash of 16 inputs.
 ...
 */
export default function poseidon16(inputs: bigint[], cacheConstants = false) {
    if (cacheConstants && !cachedConstants) {
        cachedConstants = getConstants(C, M)
    }

    return poseidonBasic(16, cachedConstants ?? getConstants(C, M))([0n, ...inputs])[0]
}
